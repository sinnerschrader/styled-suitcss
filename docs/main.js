...
var styled = __webpack_require__(/*! ../ */ "./client.js").default;
...
var BlueCard = Card.extend({
  _name: "blue"
})(_templateObject5, COLORS.blue);
var YellowCard = Card.extend({
  _name: "yellow"
})(_templateObject6, COLORS.yellow);
var PurpleCard = Card.extend({
  _name: "purple"
})(_templateObject7, COLORS.purple);
var WarningCard = Card.extend({
  _name: "warning"
})(_templateObject8, COLORS.red);
var SuccessCard = Card.extend({
  _name: "success"
})(_templateObject9, COLORS.green);
var Image = styled.img({
  _name: "Image"
})(_templateObject10);
var CardImage = Image.extend({
  _namespace: "Card"
})(_templateObject11);
var FitCardImage = Image.extend({
  _name: "fix"
})(_templateObject12);
var SmallCardImage = CardImage.extend({
  _name: "small"
})(_templateObject13);
var Copy = styled.p({
  _name: "Copy"
})(_templateObject14);
var CardCopy = Copy.extend({
  _namespace: "Card"
})(_templateObject15);
var Headline = styled.h2({
  _name: "Headline"
})(_templateObject16);
var CardHeadline = Headline.extend({
  _namespace: "Card"
})(_templateObject17);
var Svg = styled.svg({
  _name: "Svg"
})(_templateObject18);
var IconSvg = Svg.extend({
  _namespace: "Icon",
  viewBox: "0 0 24 24"
})(_templateObject19);
...
var IconType = function IconType(props) {
  return React.createElement(IconSvg, props, React.createElement(Path, {
    d: props.iconType
  }));
};
...
var Icon = styled.span({
  _name: "Icon",
  _children: function _children(props) {
    return React.createElement(IconType, props);
  }
})(_templateObject21);
var Button = styled.button({
  _name: "Button"
})(_templateObject22, COLORS.theme);
var ButtonIcon = Icon.extend({
  _namespace: "Button"
})(_templateObject23);
var CardButton = Button.extend({
  _namespace: "Card"
})(_templateObject24);
var IconCardButton = CardButton.extend({
  _name: "icon",
  _children: function _children(props) {
    return React.createElement(ButtonIcon, props);
  }
})(_templateObject25);

module.exports = function () {
  return React.createElement(LayoutQuad, {}, React.createElement(BlueCard, {
    "data-attribute": "It Works!"
  }, React.createElement(CardHeadline, {}, "Lorem ipsum dolor!"), React.createElement(CardCopy, {}, React.createElement(SmallCardImage, {
    src: "https://placehold.it/300x300/392929/bababf",
    alt: "Placeholder image"
  }), "Consectetur adipisicing elit accusantium aliquam consequuntur, dolore dolorem esse eum itaque iure laudantium, magnam provident quis soluta vel voluptates? Nam numquam pariatur quam repellendus soluta.", "Architecto consequuntur eligendi, et ex fugit libero officia, quas quis quos ratione reprehenderit sed tempore vero. Deserunt ducimus expedita libero nam quaerat.", "Ad corporis, culpa cum dolores eligendi id itaque laboriosam, molestiae necessitatibus nisi, officiis praesentium temporibus vero.", "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet, consequatur corporis, culpa cum earum est libero necessitatibus sit tempora ullam, vel voluptatum! Corporis cumque in minus modi repellat totam velit.")), React.createElement(PurpleCard, {}, React.createElement(CardImage, {
    src: "https://placehold.it/600x300/343536/abbccd",
    alt: "Placeholder image"
  })), React.createElement(WhiteCard, {}, React.createElement(FitCardImage, {
    src: "https://placehold.it/1000x400/44139a/ddd",
    alt: "Placeholder image"
  }), React.createElement(CardHeadline, {}, "Libero necessitatibus sit tempora!"), React.createElement(CardCopy, {}, "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet, consequatur corporis, culpa cum earum est libero necessitatibus sit tempora ullam, vel voluptatum! Corporis cumque in minus modi repellat totam velit.")), React.createElement(LayoutQuad, {
    "aria-labelledby": "quad"
  }, React.createElement(WhiteCard, {}, React.createElement(IconCardButton, {
    iconType: ICONS.like
  }, "Like"), React.createElement(IconCardButton, {
    iconType: ICONS.dislike
  }, "Disike")), React.createElement(SuccessCard, {}, React.createElement(CardHeadline, {}, "You succeeded")), React.createElement(WarningCard, {}, React.createElement(CardHeadline, {}, "Warning!")), React.createElement(PurpleCard, {}, React.createElement(CardCopy, {}, "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet, consequatur corporis, culpa cum earum est libero necessitatibus sit tempora ullam, vel voluptatum! Corporis cumque in minus modi repellat totam velit."))));
};
...
(0, _reactDom.hydrate)(_react.default.createElement(_app.default, null), document.getElementById("app"));
...
module.exports = __webpack_require__(/*! ./lib/client */ "./lib/client.js");
...
var styled_component_1 = __webpack_require__(/*! ./styled-component */ "./lib/styled-component.js");

var store_1 = __webpack_require__(/*! ./store */ "./lib/store.js");

var extend_component_1 = __webpack_require__(/*! ./extend-component */ "./lib/extend-component.js");

var store = new store_1.default({
  document: document
});

var create = function create(strings, args, tag, initialProps) {
  if (strings === void 0) {
    strings = [];
  }
  ...
  function (_super) {
    ...
    Component.extend = extend_component_1.default(Component, initialProps, create);
    return Component;
  }(styled_component_1.default);
...
var client_element_1 = __webpack_require__(/*! ./client-element */ "./lib/client-element.js");

var styled_1 = __webpack_require__(/*! ./styled */ "./lib/styled.js");

var Styled =
/** @class */
function (_super) {
  tslib_1.__extends(Styled, _super);

  function Styled() {
    var _this = _super !== null && _super.apply(this, arguments) || this;

    _this.createElement = client_element_1.default;
    return _this;
  }
...
var extendComponent = function extendComponent(_this, initialProps, create) {
  return function (props) {
    return function (extension) {
      ...
      var _name = initialProps._name + "--" + props._name;

      var _namespace = props._namespace + "-" + initialProps._name;

      var nextName = utils_1.oneOf({
        check: props._name,
        value: _name
      }, {
      ...
      var mergedProps = tslib_1.__assign({}, initialProps, props, {
        _children: props._children,
        _name: nextName,
        _names: (initialProps._names || []).concat([nextName])
      });
...
var elements_1 = __webpack_require__(/*! ./elements */ "./lib/elements.js");

var utils_1 = __webpack_require__(/*! ./utils */ "./lib/utils.js");

var dataOrAria = function dataOrAria(str) {
  return str === "data-" || str === "aria-";
};

var getTagAttributes = function getTagAttributes(tag) {
  var validAttributes = elements_1.htmlAttributes["*"].concat(elements_1.htmlAttributes[tag]);

  if (elements_1.svgElements.includes(tag)) {
    return validAttributes.concat(elements_1.htmlAttributes.svg);
  }

  return validAttributes;
};

var getValidAttributes = function getValidAttributes(str, tag) {
  return utils_1.isTruthy(str, getTagAttributes(tag)) || dataOrAria(str.substr(0, 5));
};

exports.default = getValidAttributes;
...
var style_element_1 = __webpack_require__(/*! ./style-element */ "./lib/style-element.js");

var utils_1 = __webpack_require__(/*! ./utils */ "./lib/utils.js");

var Stylis = __webpack_require__(/*! stylis */ "./node_modules/stylis/stylis.js");

exports.stylis = new Stylis({
  keyframe: false,
  prefix: true,
  preserve: true,
  compress: false
...
function () {
  function Store(props) {
    ...
    this.styleElement = style_element_1.default(props.document);
  ...
  Store.prototype.addStyle = function (selector, style) {
    if (!this.selectors.includes(selector)) {
      this.selectors.push(selector);
      this.styles.push(exports.stylis("." + selector, style));
      this.styles = this.styles.sort(utils_1.sortbyNames);
      this.selectors = this.selectors.sort(utils_1.sortbyNames);
  ...
  Store.prototype.append = function (el) {
...
var styleElement = function styleElement(doc) {
  if (doc === null) {
    return null;
  }

  var existingElement = doc.querySelector("style[data-styled-bem]");
...
var get_valid_atrributes_1 = __webpack_require__(/*! ./get-valid-atrributes */ "./lib/get-valid-atrributes.js");

var StyledComponent =
/** @class */
function (_super) {
  tslib_1.__extends(StyledComponent, _super);
  ...
  function StyledComponent() {
    ...
    _this.args = [];
    _this.store = {
      addStyle: function addStyle(selector, style) {}
    };
    return _this;
  }

  StyledComponent.prototype.componentDidMount = function () {
    var _a = this.initialProps,
        _name = _a._name,
        _b = _a._names,
        _names = _b === void 0 ? [] : _b,
        _namespace = _a._namespace;

    var name = _names[0];

    if (_name) {
      if (_names.length < 2 && !(name || _name).match(new RegExp("^" + _namespace))) {
        this.store.addStyle(utils_1.addNamespace(_name, _namespace), this.style);
      } else {
  ...
  Object.defineProperty(StyledComponent.prototype, "style", {
    /**
     *
     * @returns {string}
     */
    get: function get() {
      ...
      return this.strings.map(function (str, i) {
        var arg = _this.args[i];
        var injection = typeof arg === "function" ? arg(_this.props) : arg;
        return [str, injection];
      }).reduce(function (prev, current) {
        return prev.concat(current);
      }, []).filter(function (x) {
        return !utils_1.isTruthy(x);
      }).join("");
    },
    enumerable: true,
    configurable: true
  });
  Object.defineProperty(StyledComponent.prototype, "mergedProps", {
    /**
     *
     * @returns {object}
     */
    get: function get() {
      return tslib_1.__assign({}, this.initialProps, this.props, {
        // ensure correct className
        children: React.Children.toArray(typeof this.initialProps._children === "function" ? this.initialProps._children(utils_1.removeProps(this.props, ["className", "_name", "children", "_children", "_names", "_namespace"])) : this.initialProps._children).concat(React.Children.toArray(this.props.children)).filter(Boolean),
  ...
  Object.defineProperty(StyledComponent.prototype, "validProps", {
    /**
     *
     * @returns {object}
     */
    get: function get() {
      ...
      if (typeof this.tag === "string") {
        return utils_1.keepProps(tslib_1.__assign({}, this.mergedProps, {
          className: utils_1.cx.apply(void 0, [utils_1.addNamespace(this.initialProps._name, this.initialProps._namespace)].concat((this.mergedProps._names || []).map(function (name) {
            return utils_1.addNamespace(name, _this.initialProps._namespace);
          })))
        }), Object.keys(this.mergedProps).filter(function (str) {
          return get_valid_atrributes_1.default(str, _this.tag);
        }));
      }
  ...
  StyledComponent.prototype.render = function () {
    ...
    return React.createElement.apply(React, [this.tag, this.validProps].concat(this.mergedProps.children));
  };
...
function () {
  function Styled() {
    ...
    this.styled = function (tagName, initialProps) {
      return function (strings) {
        ...
        return _this.createElement(strings, args, tagName, initialProps);
      };
    };

    elements_1.default.concat(elements_1.svgElements).forEach(function (tagName) {
      _this.styled[tagName] = function (initialProps) {
        return _this.styled(tagName, initialProps);
      };
    });
  }
...
exports.isTruthy = function (input, reject) {
  if (reject === void 0) {
    reject = [undefined, null, false];
  }

  return reject.includes(input);
};
/**
 *
 * @param {object} obj
...
exports.keepProps = function (obj, removals) {
  return Object.keys(obj).filter(function (key) {
    return exports.isTruthy(key, removals);
  }).map(function (prop) {
    return _a = {}, _a[prop] = obj[prop], _a;

    var _a;
  }).reduce(function (a, b) {
    return tslib_1.__assign({}, a, b);
  }, {});
};
/**
 *
...
exports.removeProps = function (obj, removals) {
  return Object.keys(obj).filter(function (key) {
    return !exports.isTruthy(key, removals);
  }).map(function (prop) {
    return _a = {}, _a[prop] = obj[prop], _a;
...
exports.addNamespace = function (name, namespace) {
...
exports.oneOf = function () {
  ...
  return items.map(function (_a) {
    var check = _a.check,
        value = _a.value;
    return check === undefined ? null : value;
  }).filter(Boolean)[0];
};
/**
 *
...
exports.sortbyNames = function (a, b) {
  var aC = a.split("{")[0];
  var bC = b.split("{")[0];

  var _a = aC.trim().split("--"),
      aNames = _a[0],
      aModifier = _a[1];

  var _b = bC.trim().split("--"),
      bNames = _b[0],
      bModifier = _b[1];
