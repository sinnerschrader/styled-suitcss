...
test("Element--modifier renders the correct markup", t => {
  ...
  const expected = "<div class=\"Element Element--modifier\" data-reactroot=\"\"></div>"
  t.is(markup, expected);
});

test("Element-child renders the correct markup", t => {
  const markup = renderToString(React.createElement(ElementChild));
  const expected = "<span class=\"Child Element-child\" data-reactroot=\"\"></span>"
  t.is(markup, expected);
});
...
test("Element-child--modifier renders the correct markup", t => {
  ...
  const expected = "<span class=\"Child Element-child Element-child--modifier\" data-reactroot=\"\"></span>"
  t.is(markup, expected);
});
...
test("namespace-Element--modifier renders the correct markup", t => {
  ...
  const expected = "<div class=\"namespace-Element namespace-Element--modifier\" data-reactroot=\"\"></div>"
  t.is(markup, expected);
});

test("namespace-Element-child renders the correct markup", t => {
  const markup = renderToString(React.createElement(NSElementChild));
  const expected = "<span class=\"Child namespace-Element-child\" data-reactroot=\"\"></span>"
  t.is(markup, expected);
});
...
test("namespace-Element-child--modifier renders the correct markup", t => {
  ...
  const expected = "<span class=\"Child namespace-Element-child namespace-Element-child--modifier\" data-reactroot=\"\"></span>"
  t.is(markup, expected);
});

test("Styles are created correctly", t => {
  const sheet = new styled.ServerStyleSheet();
  const markup = renderToString(React.createElement(sheet.collectStyles(Element)));
...
test("Styles are gathered correctly", t => {
  const sheet = new styled.ServerStyleSheet();
  const markup = renderToString(React.createElement(sheet.collectStyles(ElementChild)));
  const styles = sheet.getStyles();
